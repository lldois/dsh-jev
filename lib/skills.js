 ...
 * @returns {Promise<{ query: string, candidates: string[], recommended: Array<{ name: string, description: string, probability: number, location?: string }>, fallbackUsed: boolean, message?: string, elapsedMs: number }>}
 */
